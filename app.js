...
const forestChallengeMusic = document.getElementById("audio1");
const forestCombatMusic = document.getElementById("audio2");
const enemyRoar = document.getElementById("audio3");
const attackSound = document.getElementById("audio4");
const fightWon = document.getElementById("audio5");
const forestFinalBattleIntro = document.getElementById("audio6");
const forestFinalBattle = document.getElementById("audio7");
...
let a = 0;
let lastChallengeInitiated = false;
let tempProgress = 0;
let selectChallenge = 0;
const section1 = {
    ...
    firstChallenge: () => {
        ...
        document.getElementById("initialNextIcons").style.display = "none";
    ...
    challenges: {
        challenge1: {question: "A small creature spots you, but seems more intrigued than anything..",
                        forward: function() {
                            ...
                            dialog.innerHTML = "The small creature beings charging you ready to attack!!"
        ...
        challenge2: {question: "You hear a slithering from behind you. A loud sound like a boulder dragging through the forest..",
                            ...
                            document.getElementById("commandIcons").style.display = "none";
                            dialog.innerHTML = "You hear a loud hiss as fangs the size of ice picks speed towards you!!"
                            setTimeout(function(){playerAttacked()}, 5000);
                            },
                    },
        challenge3: {question: "Whoa.. the ground is shaking and trees are dropping all around you.. earthquake?!",
                            ...
                            document.getElementById("commandIcons").style.display = "none";
                            dialog.innerHTML = "A massive figure slowly appears in front of you while your surroundings get demolished.."
                            setTimeout(function(){playerAttacked()}, 5000);
                            },
                    },
        challenge4: {question: "You tripped over what looks like a thick white rope, it clings on as you free your leg..",
                            ...
                            document.getElementById("commandIcons").style.display = "none";
                            dialog.innerHTML = "You barely free yourself as a creature shoots a string of web towards you!!"
                            setTimeout(function(){playerAttacked()}, 5000);
                            },
                    },
        challenge5: {question: "HP Fully Restored!!",
                    forward: function() {
                        ...
                        document.getElementById("commandIcons").style.display = "none";
                        dialog.innerHTML = "HP Fully Restored!!";
                        setTimeout(function(){dialog.innerHTML = "you see a figure slowly approaching from the other side.."}, 2000);
                        setTimeout(function(){dialog.innerHTML = "Unknown: 'You think you can leave this place? Without a true challenge?!...'"}, 8000);
                        setTimeout(function(){dialog.innerHTML = "Unknown: 'step forward and show me when you're made of...'"}, 15000);
                        setTimeout(function(){dialog.innerHTML = "Make sure you're truly ready before proceeding..."}, 22000);
                        setTimeout(function(){
                                ...
                                document.getElementById("commandIcons").style.display = "none";
                                dialog.innerHTML = "Come back when you're a real challenge, child.";
                                setTimeout(function(){dialog.innerHTML = "Progress reduced to 50";}, 4000);
                                setTimeout(function(){
    ...
    challenge: function() {
        ...
        dialog.innerHTML = selectedChallenge.question;
        ...
        document.getElementById('run').onclick = function changeContent() {
            ...
            dialog.innerHTML = "Challenge avoided.."
            if (6 < Math.floor((Math.random() * 6) + 1)) {
                ...
                setTimeout(function() {document.getElementById("commandIcons").style.display = "none"; dialog.innerHTML = "Watch out!"}, 3000)
    ...
    progressionCheck: function() {
            ...
            document.getElementById("commandIcons").style.display = "none";
            dialog.innerHTML = '<img src=\"img/walkingGit.gif\">' + '<span style=\"position:absolute; top: 20px; left: 80px; z-index=2; text-align: center;\">' + tempProgress + ' Progress Made!!</span>';
            ...
            if (section1.progress > 99) {
                ...
                setTimeout(function() {tempProgress = 0; document.getElementById("commandIcons").style.display = "none"; document.getElementById("nextIcons").style.display = "inline-block"; dialog.innerHTML = "No encounters..."; },3000)
            }   
    }
};
...
function checkLevelProgress (){ // checks player Level - invoked by "nextIcons" onclick
    if (player.progress >= player.progressNeeded) {
        ...
        healthInfo.innerHTML = player.health;
        document.getElementById("strengthInfo").innerHTML = player.strength;
        dialog.innerHTML = "Congratulations, you've leveled up to " + player.level + "!!"
        setTimeout(function() { 
            dialog.innerHTML = "Your health has increased to " + player.health + "!!"
        }, 3000);
        setTimeout(function() {
            dialog.innerHTML = "Your Strength has increased to " + player.strength + "!!"
        }, 7000);
        setTimeout(function() {

            if (player.level === 2 && player.abilities.heal.learned == "no") {
                dialog.innerHTML ="You've learned Heal!!!";
...
function checkfinalBoss(){ //Checks if defeated final boss - invoked after checkLevelProgress (above)
    if (section1.enemies.enemy14.health <= 0) {
        forestFinalBattleIntro.pause();
        dialog.innerHTML = "Unfamiliar Voice: " + '"You.. you are the first to ever defeat the forest gatekeeper"'; 
        setTimeout(function() {
            dialog.innerHTML = "Unfamiliar Voice: " + '"Proceed to the next location. People are in need.."';
        }, 4000)
        setTimeout(function() {
            dialog.innerHTML = "Unfamiliar Voice: " + 'Proceed...';
...
function playerAttacked() {
    if (selectedName === section1.enemies.enemy14) forestChallengeMusic.pause();
    ...
    if (selectChallenge === 1) {
        ...
        selectChallenge = 5;
    } else if (a === 1) selectedName = section1.enemies.enemy1;
    else if (a === 3) selectedName = section1.enemies.enemy3;
    else if (a === 4) selectedName = section1.enemies.enemy4;
    else if (a === 2) selectedName = section1.enemies.enemy2;
    ...
    attackSound.play();
    forestCombatMusic.play();
    dialog.innerHTML ="You were ambushed by " + selectedName.name + " and took " + selectedName.attack + " damage";
    player.health = player.health - selectedName.attack;
    healthInfo.innerHTML = player.health;
    section1.enemies.tempEnemyHealth = selectedName.health;
    if (player.health < 1) {
        dialog.innerHTML = "You Have Died!!!";
        setTimeout(function() { document.location.reload(true); }, 2000)
    } else if (player.health < 30) {
        dialog.innerHTML = "Be careful, you are getting weak!!!";
    ...
    } else setTimeout(function() { combatSequence(); }, 4000)
}
  
//fight sequence 
let abilityUsed
let overallDamageGiven = 0;
...
function combatSequence(param1) {
    ...
    dialog.innerHTML = "<b>Fighting</b>: " + selectedName.name
    ...
    function attack() {
        ...
        if (abilityUsed === "heal") {
            if (player.attackPoints < player.abilities.heal.attackPoints) {
                ...
                dialog.innerHTML = "You need " + player.abilities.heal.attackPoints + " attack points for this..."
                setTimeout(function() {abilityUsed = "none"; combatSequence(); }, 5000)
            } else {
                
                if (player.abilities.heal.amount + player.health > player.baseHealth){
                    player.health = player.baseHealth;
                } else player.health = player.health + player.abilities.heal.amount;

                dialog.innerHTML = "You healed " + player.abilities.heal.amount + " points!!";
                ...
                setTimeout(function() {  
                    dialog.innerHTML = "You used " + player.abilities.heal.attackPoints + " attack points..";
                }, 3000)
                setTimeout(function() {  
                    finishAttack();
                }, 6000)
        ...
        function finishAttack(){
            ...
            if (section1.enemies.tempEnemyHealth >= 1 && player.health >= 1) {
                dialog.innerHTML = "You dealt " + tempDamage + " damage to " + selectedName.name; 
                healthInfo.innerHTML = player.health;
                setTimeout(function() {attackSound.play(); dialog.innerHTML = "You received " + selectedName.attack + " damage"; }, 3000)
                setTimeout(function() { combatSequence(); }, 6000)
                return

            //if player health is below 1, you died (reloads webpage)
            } else if (player.health <= 0) {
                setTimeout(function() { dialog.innerHTML = "You Died..."; }, 1)
            ...
            //if player enemy's health is below 1, you win fight and damage stats are shown
                ...
                document.getElementById(selectedName.picID).style.animation = "attacked linear 1s";
                document.getElementById("commandIcons").style.display = "none";
                dialog.innerHTML = "Congratulations, you've won the fight!!"; 
                healthInfo.innerHTML = player.health;
                fightWon.play();
                forestCombatMusic.pause();
                forestFinalBattleIntro.pause();
                setTimeout(function() { dialog.innerHTML = "Total Damage Dealt: " + overallDamageGiven; }, 3000)
                setTimeout(function() { dialog.innerHTML = "Total Damage Received: " + overallDamageTaken; }, 6000)
                setTimeout(function() {
                    dialog.innerHTML = "You gained " + selectedName.expGiven + " XP!!!"
    ...
    document.getElementById("runAway").onclick = function () {
        ...
        if (runChance == 1) {
            dialog.innerHTML = "You escaped!!";
            lastChallengeInitiated = false;
            forestCombatMusic.pause();
            document.getElementById(selectedName.picID).style.display = "none";
            document.getElementById("nextIcons").style.display = "inline-block";
        }  else { 
            dialog.innerHTML = "You could not escape! <br>" + selectedName.attack + " damage taken";
            player.health = player.health - selectedName.attack;
            healthInfo.innerHTML = player.health;
            attackSound.play();
